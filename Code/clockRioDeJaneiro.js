/*
File: clockRioDeJaneiro.js
Description: JavaScript file for the analog clock of Rio de Janeiro.
Author: Colin Piguet
...
function updateClockHand(selector, rotation) {
  ...
  function updateClock() {
    const now = new Date();
    let hours = now.getHours() - 4; // Minus 4 hours
  
    // If the hours become negative, set them to 8 (for 12-hour format)
    if (hours < 0) {
        hours = 8;
    }
